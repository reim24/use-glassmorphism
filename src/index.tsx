...
const Demo = () => {
  ...
  return (
    <div className="glass-container">
      <div className='ball' style={{ backgroundColor: "rgb(183 35 35)", top: '400px', left: "600px" }}></div>
      <div className='ball' style={{ backgroundColor: "rgb(46, 48, 143)", top: '500px', right: "600px" }}></div>
